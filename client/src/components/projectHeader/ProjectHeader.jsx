...
const ProjectHeader = observer(({ dataUser, title, descr, descrLimit, onClick, likes, isLike, views, likeLoading, date }) => {
	...
	const calendar = (style) => {
		return (
			<svg className={style.block__img} fill="#ffffff" viewBox="0 0 24.00 24.00" id="Outline" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" stroke-width="0.00024000000000000003">

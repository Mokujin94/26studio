    ...
    <div className={style.block}>
        <div className={style.block__info}>
            ...
            <div className={style.block__infoItem}>
                ...
                <textarea className={style.block__infoItemInput + " " + style.block__infoItemInput_area} name="" id="" cols="30" rows="10"></textarea>
            </div>
            <div className={style.block__infoItem}>
                <h2 className={style.block__infoItemTitle}>Название основного файла</h2>
                <input placeholder='index.html' className={style.block__infoItemInput} type="text" />
            </div>
            <div className={style.block__infoItem}>
                <h2 className={style.block__infoItemTitle}>Превью</h2>
                <input style={{display: 'none'}} type="file" id='file_preview' />
                <label className={style.block__infoItemInput + ' ' + style.block__infoItemInput_preview} htmlFor="file_preview">Загрузите фото</label>
            </div>
        </div>

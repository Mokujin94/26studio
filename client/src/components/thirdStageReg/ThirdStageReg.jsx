...
const ThirdStageReg = observer(({ setErrorMessage, setErrorModal, setCompleteModal, setCompleteMessage }) => {
  ...
  return (
    <div className={style.third}>
      ...
      <div className={style.third__inner}>
        ...
        <CSSTransition in={successReg} timeout={300} classNames="button" unmountOnExit>

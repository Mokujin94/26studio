									...
									<div className={"profile__avatar"}>
										{Number(id) === user.user.id ? (
											...
											<>
												...
												{
													isOnline ? <div className="profile__avatar-online profile__avatar-online_true"></div> : <div className="profile__avatar-online profile__avatar-online_false">{lastTimeOnline.replace(' назад', '')}</div>
												}
											</>

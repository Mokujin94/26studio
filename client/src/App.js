  ...
  return (
    <div className="App">
      <BrowserRouter>
        <AuthProvider>
          <ScrollToTop />
          <CSSTransition in={user.modalProject} timeout={300} classNames="create-anim" mountOnEnter unmountOnExit>
            <div className="addProjectModal__bg" onClick={() => user.setModalProject(false)}>
              <AddProjectModal />
            </div>
          </CSSTransition>
          <CSSTransition in={user.modalNews} timeout={300} classNames="create-anim" mountOnEnter unmountOnExit>
            <div className="addProjectModal__bg" onClick={() => user.setModalNews(false)}>
              <ModalNewsUpload />;
            </div>
          </CSSTransition>
          <CSSTransition in={error.notAuthError} timeout={0} classNames="create-anim" mountOnEnter unmountOnExit>
            <div className="addProjectModal__bg" onClick={() => error.setNotAuthError(false)}>
              <NotAuthPopup />
            </div>
          </CSSTransition>
          <CSSTransition in={modal.modalComplete} timeout={0} classNames="node" unmountOnExit>
